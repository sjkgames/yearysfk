...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <div class="tpl-login-title"><?php echo $this->config['sitename'] ?>-重置密码</div>
            ...
            <form class="am-form tpl-form-line-form form-ajax" action="/reg/doRepwd" method="post">
                ...
                <div class="am-form-group">
                    ...
                    <button type="submit" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success tpl-login-btn">立即重置</button>
